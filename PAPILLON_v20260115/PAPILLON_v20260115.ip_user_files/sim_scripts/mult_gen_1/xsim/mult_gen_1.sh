...
#
# Script generated by Vivado on Thu Oct 09 14:43:08 +0900 2025
...
# script info
echo -e "mult_gen_1.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_14 -L mult_gen_v12_0_22 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mult_gen_1 xil_defaultlib.mult_gen_1 xil_defaultlib.glbl -log elaborate.log
}
