...
#
# Script generated by Vivado on Fri Jan 30 15:05:48 +0900 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : gig_ethernet_pcs_pma_2.sh
...
#
# Usage        : gig_ethernet_pcs_pma_2.sh
#                gig_ethernet_pcs_pma_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                gig_ethernet_pcs_pma_2.sh [-reset_run]
#                gig_ethernet_pcs_pma_2.sh [-reset_log]
#                gig_ethernet_pcs_pma_2.sh [-help]
#
...
# script info
echo -e "gig_ethernet_pcs_pma_2.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./gig_ethernet_pcs_pma_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L gig_ethernet_pcs_pma_v16_2_21 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot gig_ethernet_pcs_pma_2 xil_defaultlib.gig_ethernet_pcs_pma_2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim gig_ethernet_pcs_pma_2 -key {Behavioral:sim_1:Functional:gig_ethernet_pcs_pma_2} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb gig_ethernet_pcs_pma_2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./gig_ethernet_pcs_pma_2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: gig_ethernet_pcs_pma_2.sh [-help]\n\
Usage: gig_ethernet_pcs_pma_2.sh [-step]\n\
Usage: gig_ethernet_pcs_pma_2.sh [-lib_map_path]\n\
Usage: gig_ethernet_pcs_pma_2.sh [-reset_run]\n\
Usage: gig_ethernet_pcs_pma_2.sh [-reset_log]\n\
Usage: gig_ethernet_pcs_pma_2.sh [-keep_index]\n\
Usage: gig_ethernet_pcs_pma_2.sh [-noclean_files]\n\n\
