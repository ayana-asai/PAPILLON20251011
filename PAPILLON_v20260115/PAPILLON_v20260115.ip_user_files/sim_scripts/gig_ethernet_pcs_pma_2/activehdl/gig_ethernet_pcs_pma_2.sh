...
#                script (type 'gig_ethernet_pcs_pma_2.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/daq/Desktop/PAPILLON_asai/PAPILLON_v20260115/PAPILLON_v20260115.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
