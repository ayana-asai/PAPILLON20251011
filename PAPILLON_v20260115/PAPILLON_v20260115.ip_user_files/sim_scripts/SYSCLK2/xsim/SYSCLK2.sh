...
#
# Script generated by Vivado on Thu Oct 09 14:30:58 +0900 2025
...
#
# Usage        : SYSCLK2.sh
#                SYSCLK2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                SYSCLK2.sh [-reset_run]
#                SYSCLK2.sh [-reset_log]
#                SYSCLK2.sh [-help]
#
...
# script info
echo -e "SYSCLK2.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./SYSCLK2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot SYSCLK2 xil_defaultlib.SYSCLK2 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SYSCLK2.wdb xsim.dir libdpi.so)
...
Usage: SYSCLK2.sh [-step]\n\
Usage: SYSCLK2.sh [-lib_map_path]\n\
Usage: SYSCLK2.sh [-reset_run]\n\
Usage: SYSCLK2.sh [-reset_log]\n\
Usage: SYSCLK2.sh [-keep_index]\n\
