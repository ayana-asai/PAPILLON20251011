...
#
# Script generated by Vivado on Thu Oct 09 14:28:45 +0900 2025
...
#
# Usage        : SYSCLK0.sh
#                SYSCLK0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                SYSCLK0.sh [-reset_run]
#                SYSCLK0.sh [-reset_log]
#                SYSCLK0.sh [-help]
#
...
# script info
echo -e "SYSCLK0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./SYSCLK0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot SYSCLK0 xil_defaultlib.SYSCLK0 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SYSCLK0.wdb xsim.dir libdpi.so)
...
Usage: SYSCLK0.sh [-step]\n\
Usage: SYSCLK0.sh [-lib_map_path]\n\
Usage: SYSCLK0.sh [-reset_run]\n\
Usage: SYSCLK0.sh [-reset_log]\n\
Usage: SYSCLK0.sh [-keep_index]\n\
