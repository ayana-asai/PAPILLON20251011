...
#
# Script generated by Vivado on Thu Oct 09 14:39:16 +0900 2025
...
#
# Usage        : mem_8_4K.sh
#                mem_8_4K.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mem_8_4K.sh [-reset_run]
#                mem_8_4K.sh [-reset_log]
#                mem_8_4K.sh [-help]
#
...
# script info
echo -e "mem_8_4K.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mem_8_4K.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mem_8_4K xil_defaultlib.mem_8_4K xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mem_8_4K.wdb xsim.dir libdpi.so)
...
Usage: mem_8_4K.sh [-step]\n\
Usage: mem_8_4K.sh [-lib_map_path]\n\
Usage: mem_8_4K.sh [-reset_run]\n\
Usage: mem_8_4K.sh [-reset_log]\n\
Usage: mem_8_4K.sh [-keep_index]\n\
